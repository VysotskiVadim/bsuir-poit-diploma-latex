...
\newcommand{\thesisSmall}{Программное средство распознавания автомобильных номеров для автоматизированной автомобильной стоянки}
...
\newcommand{\workSection}{Информатика и информационные технологии. Программное обеспечение вычислительной техники и автоматизированных систем.}